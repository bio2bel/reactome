...
Reactome is a pathway database comprising established pathways between different species that contain genetic as well as chemical information.
This package downloads pathway information from Reactome's API and store it in template data model relating genes and chemical to pathways.
Moreover, the hierarchy of the pathways is maintained enabling pathway comparison and exploration in the `ComPath environment <https://github.com/ComPath>.
